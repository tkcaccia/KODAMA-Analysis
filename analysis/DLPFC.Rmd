...
pca <- pca_results$u %*% diag(pca_results$d)[,1:50]
rownames(pca)=rownames(data_sub)
colnames(pca)=paste("PC",1:50,sep="")
...
save(pca,samples,xy,labels,file="output/pca.RData")
...
plot(kk_UMAP,pch=20,col=as.factor(clu))
  ...
  load("../Optimization/Data/rem.RData")
  selFB=!(rownames(kk_UMAP) %in% rem)
...
plot_slide(xy,samples,ref,col=cols_cluster)
  ...
  #  2_FALSE_2000_3_100_0.3_15_20_withFB
save(kk_UMAP,samples,xy,labels,ref,clu,file="output/DLFPC-Br5595.RData")
...
save(kk_UMAP,samples,xy,labels,ref,clu,file="output/DLFPC-Br5292.RData")
...
save(kk_UMAP,samples,xy,labels,ref,clu,file="output/DLFPC-Br8100.RData")
