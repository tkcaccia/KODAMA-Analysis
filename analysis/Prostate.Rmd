...
plot7=plot_slide(xy,samples,as.factor(clu),nrow=1,col = cols_cluster,size.dot = 1)
...
plot6
dev.off()
svg("output/Figures/Prostate/prostate7.svg",height = 3,width = 10)
plot7
dev.off()
```
...
write.csv(ma[1:30,],"output/Prostate-trajectory.csv")
...
```{r, fig.width=10, fig.height=4, warning=FALSE, message=FALSE, echo=FALSE}
write.csv(ma[1:30,],"output/Prostate-GSEA.csv")
