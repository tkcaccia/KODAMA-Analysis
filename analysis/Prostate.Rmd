...
save(spe, file = "C:/Users/T0087231/Documents/data/prostate.RData")
```
...
```{r, fig.width=10, fig.height=4, warning=FALSE, message=FALSE}
patho <- read.csv("C:/Users/T0087231/Documents/Prostate/Adenocarcinoma/outs/Pathology.csv")
```
...
```{r, fig.width=10, fig.height=4, warning=FALSE, message=FALSE}
geneset <- GSA.read.gmt("C:/Users/T0087231/Documents/Genesets/msigdb_v2023.2.Hs_GMTs/h.all.v2023.2.Hs.symbols.gmt")
names(geneset$genesets) <- geneset$geneset.names
genesets = geneset$genesets
```

#### GSVA Parameters and Enrichment Score Calculation
